...
test("Baseline Reset Button Test", async ({page}) => {
  ...
  // 차량 종류별 기본 값 버튼 누름
  await page.locator("text=Baseline휘발유대경유대LPG대수소대전기대기본값 적용 >> button").click();
  // 기본값 적용됫는지 확인
  ...
  await page
    .locator("text=Baseline평균 출퇴근 거리km자동차%대중교통%도보 및 자전거%기본값 적용 >> button")
    .click();
  // 기본값 적용됫는지 확인
