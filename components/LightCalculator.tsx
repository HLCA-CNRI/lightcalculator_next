      ...
      <div className="px-6 md:px-12 lg:px-32 grid  place-items-center min-h-screen  ">
        <div className=" mt-10  grid gap-4 xs:grid-cols-1 md:grid-cols-3 ">
          <h1 className=" h-auto bg-slate-200 xs:col-span-1 md:col-span-3 mb-10 rounded-lg ">
            <div className="px-6">
              ...
              <div className=" md:w-[56%] text-lg text-gray-600">
                개인, 기업, 기관 소유 차량이 전기차로 빠르게 전환되고 있고 COVID-19 이후 재택근무의 비율이 급격히 증가했습니다. 탄소중립연구원의 기후 임팩트
                계산기는 의사결정에 따른 기후 변화 영향력을 측정합니다. <br></br>
                <br></br>아래 간단한 항목들에 답해보시고 귀사의 기후 변화 영향력을 측정해보세요.
              </div>
              <button onClick={executeScroll} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg mt-5 w-40">
                시작하기
              </button>
            </div>
          ...
          <div className=" bg-cnri_light_blue flex justify-center flex-col items-center rounded-lg">
            ...
            <NumberInput type="baseline" unit="명" setNumber={bSetCompanyEmployeeSize} initial={bCompanyEmployeeSize.toString()} />
          </div>
          <div className=" bg-cnri_light_green flex justify-center flex-col items-center rounded-lg   ">
            ...
            <NumberInput type="forecast" unit="명" setNumber={fSetCompanyEmployeeSize} initial={fCompanyEmployeeSize.toString()} />
          </div>

          <div className="mb-3 pr-10 ">
            <h2 className="text-xl font-semibold mb-2">차량 종류별 대수</h2>
            <p className="text-gray-600">최근 다양한 종류의 차량이 많이 상용화되고 있습니다. 귀사의 차량 종류별 대수는 어떻게 되시나요?</p>
          </div>
          <div className=" bg-cnri_light_blue flex justify-center flex-col items-center rounded-lg   ">
            <div className="  w-[100%] text-lg visible md:hidden">
              <div className="ml-4 py-2">Baseline</div>
          ...
          <div className="mb-3 pr-10  ">
            ...
            <p className="text-gray-600">
              다양한 종류의 차량이 생기며 차량 연료도 다양해지고 있습니다. 귀사에서 연간 소비하고 있는 총 차량 연료 비용을 입력해주세요.
            </p>
          </div>
          <div className=" bg-cnri_light_blue flex justify-center flex-col items-center rounded-lg   ">
            <div className="  w-[100%] text-lg visible md:hidden">
            ...
            <NumberInput type="baseline" unit="만원" setNumber={bSetCompanyGasPrice} initial={bCompanyGasPrice.toString()} />
          </div>
          <div className=" bg-cnri_light_green flex justify-center flex-col items-center rounded-lg   ">
            <div className="  w-[100%] text-lg visible md:hidden">
              <div className="ml-4 py-2">Forecast</div>
            ...
            <NumberInput type="forecast" unit="만원" setNumber={fSetCompanyGasPrice} initial={fCompanyGasPrice.toString()} />
          </div>

          <div className="mb-3 pr-10  ">
            <h2 className="text-xl font-semibold mb-2">근무 형태</h2>
            <p className="text-gray-600">최근 재택근무를 시행하는 기업이 많아지고 있습니다. 귀사는 평균적으로 오피스 출근이 얼마나 되시나요??</p>
          </div>
          <div className="bg-cnri_light_blue flex justify-center flex-col items-center rounded-lg   ">
            <div className="  w-[100%] text-lg visible md:hidden">
              <div className="ml-4 py-2">Baseline</div>
          ...
          <div className="mb-3 pr-10  ">
            ...
            <p className="text-gray-600">
              귀사 임직원의 평균적인 출퇴근 거리와 방식이 어떻게 되나요? 자동차를 통한 출퇴근은 버스나 지하철 같은 대중교통에 비해 많은 탄소 배출이 발생합니다.
            </p>
          </div>
          ...
          <div className="mb-3  pr-10 ">
            ...
            <p className="text-gray-600">현재 귀사에 공급되는 전기는 신재생 에너지입니까? 신재생 에너지로의 전환은 탄소 배출 감소에 도움이 될 수 있습니다.</p>
          </div>
          <div className=" bg-cnri_light_blue flex justify-center flex-col items-center rounded-lg   ">
            <div className="  w-[100%] text-lg visible md:hidden">
              <div className="ml-4 py-2">Baseline</div>
            ...
            <CheckBox type="baseline" label="신재생 에너지 사용" setChecked={bSetUseRenewableEnergy} />
          </div>
          <div className=" bg-cnri_light_green flex justify-center flex-col items-center rounded-lg   ">
            <div className="  w-[100%] text-lg visible md:hidden">
              <div className="ml-4 py-2">Forecast</div>
            ...
            <CheckBox type="forecast" label="신재생 에너지 사용" setChecked={fSetUseRenewableEnergy} />
          </div>

          <div className="mb-3 pr-10  ">
            <h2 className="text-xl font-semibold mb-2">사무실 면적</h2>
            <p className="text-gray-600">큰 사무실일수록 전기와 난방으로 인한 배출량이 많습니다. 귀사의 사무실 면적은 어떻게 되나요?</p>
          </div>
          <div className=" bg-cnri_light_blue flex justify-center flex-col items-center rounded-lg  ">
            <div className="  w-[100%] text-lg visible md:hidden">
              <div className="ml-4 py-2">Baseline</div>
          ...
          <div className="mb-3  pr-10 ">
            ...
            <p className="text-gray-600">글로벌 시대인만큼 해외로의 출장도 많아지고 있습니다.귀사에서의 연간 총 해외 출장은 몇 번이신가요?</p>
          </div>
          <div className=" bg-cnri_light_blue flex justify-center flex-col items-center rounded-lg">
            <div className="  w-[100%] text-lg visible md:hidden">
              <div className="ml-4 py-2">Baseline</div>
