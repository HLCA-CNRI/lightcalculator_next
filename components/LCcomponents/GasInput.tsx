    ...
    <div className="w-[100%]">
      {type == "baseline" ? (
        <div className="rounded-lg p-2  m-5">
          ...
          <PercentInput Objectkey="fuel" value="gasoline" isBaseline={type == "baseline" ? true : false} title="휘발유" unit="대" color="#2f5597" />
          <PercentInput Objectkey="fuel" value="diesel" isBaseline={type == "baseline" ? true : false} title="경유" unit="대" color="#2e75b6" />
          <PercentInput Objectkey="fuel" value="lpg" isBaseline={type == "baseline" ? true : false} title="LPG" unit="대" color="#5b9bd5" />
          <PercentInput Objectkey="fuel" value="hydrogen" isBaseline={type == "baseline" ? true : false} title="수소" unit="대" color="#9dc3e6" />
          <PercentInput Objectkey="fuel" value="electric" isBaseline={type == "baseline" ? true : false} title="전기" unit="대" color="#bdd7ee" />
      ...
      기본값 적용
        ...
        <div className="rounded-lg p-2  m-5">
          ...
          <PercentInput Objectkey="fuel" value="gasoline" isBaseline={type == "baseline" ? true : false} title="휘발유" unit="대" color="#385723" />
          <PercentInput Objectkey="fuel" value="diesel" isBaseline={type == "baseline" ? true : false} title="경유" unit="대" color="#548235" />
          <PercentInput Objectkey="fuel" value="lpg" isBaseline={type == "baseline" ? true : false} title="LPG" unit="대" color="#70ad47" />
          <PercentInput Objectkey="fuel" value="hydrogen" isBaseline={type == "baseline" ? true : false} title="수소" unit="대" color="#a9d18e" />
          <PercentInput Objectkey="fuel" value="electric" isBaseline={type == "baseline" ? true : false} title="전기" unit="대" color="#c5e0b4" />
      ...
      <label className="inline-flex items-center w-[100%] justify-end pr-5  my-5">
        <button
          ...
          className={`${type == "baseline" ? `bg-blue-600 hover:bg-blue-400` : `bg-green-700 hover:bg-lime-600`} text-white font-bold py-2 px-4 rounded-lg`}>
          기본값 적용
        </button>
      </label>
    </div>
